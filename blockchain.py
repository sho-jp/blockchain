...
class BlockChain(object):
    ...
    def add_transaction(self, sender_blockchain_address,
                        recpient_blockchain_address, value):
        transaction = utils.sorted_dict_by_key({
            'sender_blockchain_address': sender_blockchain_address,
            'recpient_blockchain_address': recpient_blockchain_address,
            'value': float(value)
        })
    ...
    def mining(self):
        self.add_transaction(
            ...
            recpient_blockchain_address=self.blockchain_address,
            value=MINING_REWARD
        )
        ...
        logger.info({'actions': 'mining', 'status': 'success'})
        return True, nonce
    ...
    def calculate_total_amount(self, blockchain_address):
        ...
        for block in self.chain:
            for transaction in block['transactions']:
                ...
                if blockchain_address == transaction['recpient_blockchain_address']:
                    total_amount += value
